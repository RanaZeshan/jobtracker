...
@section('title', 'Earnings Details - ' . $user->name)
    ...
    <div class="details-page">
        ...
        <div class="details-header">
            <div class="row align-items-end">
                <div class="col-md-6">
                    <h1>💵 {{ $user->name }}'s Earnings</h1>
                    <p>From {{ date('M d, Y', strtotime($fromDate)) }} to {{ date('M d, Y', strtotime($toDate)) }}</p>
                </div>
                <div class="col-md-6 mt-3 mt-md-0">
                    <form method="GET" action="{{ route('admin.earnings.show', $user) }}" class="date-filter-form">
        ...
        {{-- Back Button --}}
        <div class="mb-3">
            <a href="{{ route('admin.earnings.index', ['from_date' => $fromDate, 'to_date' => $toDate]) }}" class="btn btn-outline-secondary rounded-pill">
                <i class="bi bi-arrow-left me-2"></i>Back to Earnings Overview
            </a>
        </div>
